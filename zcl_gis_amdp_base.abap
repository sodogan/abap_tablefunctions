...
* Declare local variables
     ...
     select count( actualgeometryid )
      ...
      lt_actual_geometries = apply_filter ( "GISDATA"."ACTUALGEOMETRY" , :P_WHERE) ; --SELECT  actualgeometryid,


      return select actualgeometryid, actualblockid, gpsquality from :lt_actual_geometries;

*      return select * from :lt_filtered;
*  return  SELECT  actualgeometryid,
*                  actualblockid,
*                  gpsquality
*          from "GISDATA"."ACTUALGEOMETRY"
**          limit :lv_record_number
*           where actualgeometryid = :p_geometryid;
